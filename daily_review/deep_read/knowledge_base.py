...
# ============================================================
# 一级猎场 — 跑完整 deep_read (Stage1+2)
HUNTING_GROUND_DOMAINS = {
    "算力硬件",   # 芯片/设备/材料/封装/EDA — 302精读/4条>=60
    "新能源",     # 电池/储能/光伏 — 62精读/2条>=60
}

# 二级猎场 — 仅 Stage1 筛选，不跑 LLM（公告侧机会少，催化主要来自产业链调研）
HUNTING_GROUND_TIER2 = {
    "机器人",     # 77精读/0条>=60 — 催化在供应链端非公告
    "化工材料",   # 31精读/0条>=60 — 同上
}
