...
EXPECTED_OUTPUTS = [
    ...
    ("四源交叉",   "reports/feeds/primary_synthesis_{date}.md",    "today",      "synthesis",      "python daily_review/primary_synthesis.py",           "HIGH",     "23:00"),
    ...
    ("复盘摘要",   "reports/feeds/review_summary_{date}.md",        "today",      "summary",        "python daily_review/review_summary.py",              "MEDIUM",   "23:00"),
