...
EXPECTED_OUTPUTS = [
    ...
    ("复盘摘要",   "reports/feeds/review_summary/review_summary_{date}.md",        "today",      "summary",        "python daily_review/review_summary.py",              "MEDIUM",   "23:00"),
    ("推荐追踪",   "reports/feeds/recap/recap_{date}.md",                 "today",      "track",          "python daily_review/track_recommendations.py",       "LOW",      "23:00"),
